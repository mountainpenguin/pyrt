...
Usage in a template:
    #extends modules.Cheetah.Tools.CGITemplate
    #implements respond
    $cgiHeaders#slurp
...
2. The Python class
    from modules.Cheetah.Tools import CGITemplate
...
modules.Cheetah.Utils.WebInputMixin (available in all templates without importing
anything), use Python's 'cgi' module, or make your own arrangements.

This class inherits from modules.Cheetah.Template to make it usable in Cheetah's
...
class CGITemplate(Template):
    """Methods useful in CGI scripts.
       ...
       Any class that inherits this mixin must also inherit modules.Cheetah.Servlet.
    """
