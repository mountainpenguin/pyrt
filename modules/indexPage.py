...
class Index:
    ...
    def index(self, password=None, view=None, sortby=None, reverse=False):
        ...
        html_insert = """
                ...
                <div id="main_body">
                    <div id="add_torrent">
                        <img alt="Add Torrent" src="/images/add.png" id="add_img" onclick="show_add_dialogue(this.parentNode);"> <span id="add_text">Add a torrent</span>
                        <!-- <div id="add_torrent_dialogue"></div> -->
                    </div>
                    <div id="global_stats">
                        <h2>Global Stats</h2>
