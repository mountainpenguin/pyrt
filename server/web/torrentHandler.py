    ...
    def torrentHTML(self, torrentList, sort, reverse=False):
        ...
        for t in torrentList:
            ...
            if status == "Stopped" or status == "Paused":
                stopstart = "<span id='control_start' class='control_button' title='Start Torrent'><img onclick='command(\"start_torrent\",\"%(t_id)s\")' class='control_image' alt='Start' src='../images/start.png'></span>"
            else:
                stopstart = "<span id='control_pause' class='control_button' title='Pause Torrent'><img onclick='command(\"pause_torrent\",\"%(t_id)s\")'class='control_image' alt='Pause' src='../images/pause.png'></span>"
            torrent_html += """
                <tr onmouseover='select_torrent(this);' 
                    ...
                    <td>%(control_startpause)s %(control_stop)s %(control_remove)s %(control_delete)s</td>
                        ...
                        """ % {
                            ...
                            "control_stop" : "<span id='control_stop' class='control_button' title='Stop Torrent'><img onclick='command(\"stop_torrent\",\"%(t_id)s\")' class='control_image' alt='Stop' src='../images/stop.png'></span>",
                            "control_remove" : "<span id='control_remove' class='control_button' title='Remove Torrent'><img onclick='command(\"remove_torrent\",\"%(t_id)s\")' class='control_image' alt='Remove' src='../images/remove.png'></span>",
                            "control_delete" : "<span id='control_delete' class='control_button' title='Remove Torrent and Files'><img onclick='command(\"delete_torrent\",\"%(t_id)s\")' class='control_image' alt='Delete' src='../images/delete.png'></span>",
                        }
        torrent_html += "\n             </table>"
