...
function handleMessage(a){if(0==a.data.indexOf("ERROR"))console.log("socket error:",a.data);else{a=JSON.parse(a.data);var d=a.request,c=a.response;"filetree"==d?(a=$(c),a.treeview({collapsed:!0}),$("#path_browse_div").append(a)):"exists"==d?c?$("#path").css("color",""):$("#path").css("color","red"):"create"==d?!0===c?($("#progressbar").addClass("hidden"),constructTorrent(a.output)):isNaN(c)?console.log(c):$("#progressbar").progressbar("option","value",c):console.log("request:",d,"response:",c)}}
function constructTorrent(a){var d=$("<div />").addClass("downloadme"),c=$("<img />").attr("src","images/document.png").attr("title","Download torrent");a=$("<a href='downloadcreation?filename="+a+"' />").append(c);d.append(a);$("#progressbar").parent().append(d)};
