...
function add_torrentrow(a,b,c){c=$("<tr />").addClass("torrent-div").attr("id","torrent_id_"+a);b.completed?c.append($("<td />").attr("id","t_name_"+a).addClass("t_name").html(b.name)):c.append($("<td />").attr("id","t_name_"+a).html(b.name).addClass("progress-gradient t_name").css("background-size",b.percentage+"%, auto"));c.append($("<td />").attr("id","t_size_"+a).html(b.size)).append($("<td />").attr("id","t_ratio_"+a).attr("title",b.up_total+" up / "+b.down_total+" down").html(b.ratio)).append($("<td />").attr("id",
